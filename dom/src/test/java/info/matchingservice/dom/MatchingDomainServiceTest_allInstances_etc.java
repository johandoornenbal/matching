...
public class MatchingDomainServiceTest_allInstances_etc {

    private SomeDomainService someDomainService;
    static class SomeDomainObject extends MatchingDomainObject<SomeDomainObject> {
        public SomeDomainObject() {
            super(null);
        }
    }

    static class SomeDomainService extends MatchingDomainService<SomeDomainObject> {
        Class<?> entityType;

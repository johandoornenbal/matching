...
public abstract class MatchingDomainService<T> extends MatchingService<T> {
    
    private final Class<T> entityType;
    
    protected MatchingDomainService(
            final Class<? extends MatchingDomainService<T>> serviceType, 

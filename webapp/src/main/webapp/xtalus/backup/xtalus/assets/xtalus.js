...
define('xtalus/models/activeperson', ['exports', 'ember-data'], function (exports, DS) {
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        element(env, element7, context, "action", ["getUserProfile", get(env, context, "selectedPerson.uniqueItemId")], {});
...
define('xtalus/tests/models/activeperson.jshint', function () {

  'use strict';

  module('JSHint - models');
  test('models/activeperson.js should pass jshint', function() { 
    ok(true, 'models/activeperson.js should pass jshint.'); 
  });
...
if (runningTests) {
  ...
  require("xtalus/app")["default"].create({"name":"xtalus","version":"0.0.0.5ba9108f"});
}

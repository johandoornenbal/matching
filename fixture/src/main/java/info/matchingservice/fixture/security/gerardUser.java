...
public class gerardUser extends AbstractUserFixtureScript {

    public static final String USER_NAME = "gerard";
    public static final String EMAIL = "gerard@example.com";

...
public class rembrandtUser extends AbstractUserFixtureScript {

    public static final String USER_NAME = "rembrandt";
    public static final String EMAIL = "rembrandt@example.com";

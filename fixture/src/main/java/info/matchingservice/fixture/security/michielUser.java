...
public class michielUser extends AbstractUserFixtureScript {

    public static final String USER_NAME = "michiel";
    public static final String EMAIL = "michiel@example.com";

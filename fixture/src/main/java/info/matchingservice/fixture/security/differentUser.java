...
public class differentUser extends AbstractUserFixtureScript {

    public static final String USER_NAME = "different_owner";
    public static final String EMAIL = "different_owner@example.com";

...
public class jeanneUser extends AbstractUserFixtureScript {

    public static final String USER_NAME = "jeanne";
    public static final String EMAIL = "jeanne@example.com";
